%电路单元“from”提取
function [CompleteCell,UnCompleteCell,ci,ui,k,fidin]=GetFrom2(TempCell,CompleteCell,UnCompleteCell,ci,ui,k,fidin)
...
if(flag==1)
    ...
    CompleteCell{1,ci}(1,10)={0}; %指该单元的关键性
    ...
    UnCompleteCell{1,ui}(1,10)={0}; %指该单元的关键性
end
